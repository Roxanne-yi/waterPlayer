...
void playSolenoid(int section)
{
        ...
        int muxSection[16][8] =
        {
                {9, 9, 9, 9, 9, 9, 9, 9},  //Section 0
                {-5, 0, -6, -6, 0 ,5, 0, 9},  //Section 1
                {-3, 0, -4, -3, 0, 2, 0, 9},  //Section 2
                {-3, -4, -5, -3, -4, -5, -6, -5},  //Section 3
                {3, 3, 4, 5, 9, 9, 9, 9},  //Section 4
                {-6, -5, -6, -5, -3, -6, 5, 9},  //Section 5
                {-8, -7, 6, 4, 7, 9, 9, 9},  //Section 6
                {3, 5, 6, -5, -3, 9, 9, 9},  //Section 7
                {5, 4, 3, 2, 9, 9, 9, 9},  //Section 8
                {3, 6, 5, -6, -5, 9, 9, 9},  //Section 9
                {0, -5, -6, -7, 8, 0, -7, 9},  //Section 10
                {-1, -2, -3, -4, -5, -5, -5, -3},  //Section 11
                {-5, -6, -5, -6, -5, -5, 5, 9},  //Section 12
                {1, 2, 3, 1, 9, 9, 9, 9},  //Section 13
                {-5, -8, -7, -6, -5, -5, 3, 9},  //Section 14
                {3,-3,-5, -6,-8, -8, -6, 9}  //Section 15
        };

        //loop through the 8 note
        for(int i = 0; i < 8; i ++)
        {
